...
T = TypeVar("T", bound="PaginatedArtifactList")
...
class PaginatedArtifactList:
    ...
    Attributes:
        ...
        results (Union[Unset, List['Artifact']]):
    """

    count: Union[Unset, int] = UNSET
    next_: Union[None, Unset, str] = UNSET
    previous: Union[None, Unset, str] = UNSET
    results: Union[Unset, List["Artifact"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            results_item = Artifact.from_dict(results_item_data)

            results.append(results_item)

        paginated_artifact_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_artifact_list.additional_properties = d
        return paginated_artifact_list
