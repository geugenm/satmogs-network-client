...
T = TypeVar("T", bound="PaginatedStationList")


@_attrs_define
class PaginatedStationList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            results_item = Station.from_dict(results_item_data)

            results.append(results_item)

        paginated_station_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_station_list.additional_properties = d
        return paginated_station_list
